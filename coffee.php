  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <?php
                    ...
                    ?>
                    <a href="mycart.php" class="btn btncart">My Cart (<?php echo $count; ?>)</a>
                    </div>
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                ...
                <img src="assets/img/menu/latte.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Cappuccino</h4>
                <p>₹100</p>
              ...
              <div class="col-lg-4 menu-item">
              <form action="manage_cart.php" method="post">
                <img src="assets/img/menu/mocha.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Frappuccino </h4>
                <p>₹250</p>
                <button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
              ...
              <div class="col-lg-4 menu-item">
              <form action="manage_cart.php" method="post">
                <img src="assets/img/menu/americano.jpg"class="menu-img img-fluid" alt=""></a>
                <h4>Americano</h4>
                <p>₹180</p>
